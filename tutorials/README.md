# Taurus CLI Tutorials

Comprehensive tutorials for mastering Taurus CLI - a complete Claude Code clone with AI-powered development capabilities.
...
### Core Features
3. **[Hooks System Tutorial](./03-hooks.md)** - Automate your workflow with event-driven hooks
4. **[Slash Commands Tutorial](./04-slash-commands.md)** - Create custom commands for common tasks
5. **[Skills System Tutorial](./05-skills.md)** - Build reusable AI capabilities

### Advanced Features
6. **[MCP Integration Tutorial](./06-mcp-integration.md)** - Connect to external tools and data
7. **[Subagents Tutorial](./07-subagents.md)** - Launch specialized agents for complex tasks
8. **[Session Management Tutorial](./08-sessions.md)** - Manage and resume conversations

### Real-World Workflows
9. **[Code Review Workflow](./09-code-review-workflow.md)** - Automated code review process
10. **[Project Setup Workflow](./10-project-setup-workflow.md)** - Bootstrap new projects
...
2. Quick Start Guide
3. Slash Commands Tutorial

### Intermediate
4. Hooks System Tutorial
5. Skills System Tutorial
6. Session Management Tutorial
...
**Want to automate tasks?** See [Hooks System Tutorial](./03-hooks.md)

**Need to connect external tools?** See [MCP Integration Tutorial](./06-mcp-integration.md)
...
- **Issues:** https://github.com/az9713/taurus-cli/issues
- **Discussions:** https://github.com/az9713/taurus-cli/discussions
- **Examples:** See the `examples/` directory in this repo
